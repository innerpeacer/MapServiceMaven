...
public class TYBrtLinuxResourceManager implements TYIBrtResourceManager {
	private static final String RAW_DATA_ROOT_LINUX = "/brt_res/BrtMapProject/BrtMapRawData";
	private static final String VECTOR_TILE_ROOT_LINUX = "/usr/local/apache-tomcat-7.0.81/webapps/BrtMapResource/mapdata";

	private static String NODE_PATH_LINUX = "/usr/local/bin/node";

	private static String FONT_DIR_LINUX = "/brt_res/BrtMapProject/BrtMapRawData";
	private static String FONTMIN_DIR_LINUX = "/brt_res/BrtMapProject/Fontmin";
	private static String GLYPHS_DIR_LINUX = "/usr/local/apache-tomcat-7.0.81/webapps/BrtMapResource/glyphs";
	private static String FONTMIN_SCRIPT_PATH_LINUX = "/brt_res/BrtMapProject/NodeJS/BrtFontTool/script/node-fontmin.js";
	private static String GLYPHS_SCRIPT_PATH_LINUX = "/brt_res/BrtMapProject/NodeJS/BrtFontTool/script/node-glyphs.js";
