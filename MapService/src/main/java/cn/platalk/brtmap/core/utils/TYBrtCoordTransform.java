package cn.platalk.brtmap.core.utils;

public class TYBrtCoordTransform {
	class TransCoord2D {
		public double x;
		public double y;
	...
	public TYBrtCoordTransform(double[] originalCoordArray, double[] targetCoordArray) throws Exception {
