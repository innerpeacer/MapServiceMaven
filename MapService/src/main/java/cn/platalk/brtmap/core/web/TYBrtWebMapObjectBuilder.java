...
public class TYBrtWebMapObjectBuilder {
	...
	public static JSONObject generateCityJson(TYCity city) throws JSONException {
		...
		cityObject.put(TYBrtWebMapFields.KEY_WEB_CITY_SHORT_NAME, city.getSname());
		cityObject.put(TYBrtWebMapFields.KEY_WEB_CITY_LONGITUDE, city.getLongitude());
		cityObject.put(TYBrtWebMapFields.KEY_WEB_CITY_LATITUDE, city.getLatitude());
	...
	public static JSONObject generateBuildingJson(TYBuilding building) throws JSONException {
		...
		buildingObject.put(TYBrtWebMapFields.KEY_WEB_BUILDING_CITY_ID, building.getCityID());
		buildingObject.put(TYBrtWebMapFields.KEY_WEB_BUILDING_ID, building.getBuildingID());
		buildingObject.put(TYBrtWebMapFields.KEY_WEB_BUILDING_NAME, building.getName());
		buildingObject.put(TYBrtWebMapFields.KEY_WEB_BUILDING_LONGITUDE, building.getLongitude());
		buildingObject.put(TYBrtWebMapFields.KEY_WEB_BUILDING_LATITUDE, building.getLatitude());
		buildingObject.put(TYBrtWebMapFields.KEY_WEB_BUILDING_ADDRESS, building.getAddress());
		buildingObject.put(TYBrtWebMapFields.KEY_WEB_BUILDING_INIT_ANGLE, building.getInitAngle());
		buildingObject.put(TYBrtWebMapFields.KEY_WEB_BUILDING_ROUTE_URL, building.getRouteURL());
		buildingObject.put(TYBrtWebMapFields.KEY_WEB_BUILDING_OFFSET_X, building.getOffset().x);
		buildingObject.put(TYBrtWebMapFields.KEY_WEB_BUILDING_OFFSET_Y, building.getOffset().y);
		buildingObject.put(TYBrtWebMapFields.KEY_WEB_BUILDING_STATUS, building.getStatus());
	...
	public static JSONObject generateMapInfoJson(TYMapInfo mapInfo) throws JSONException {
		...
		mapInfoObject.put(TYBrtWebMapFields.KEY_WEB_MAPINFO_CITYID, mapInfo.getCityID());
		mapInfoObject.put(TYBrtWebMapFields.KEY_WEB_MAPINFO_BUILDINGID, mapInfo.getBuildingID());
		mapInfoObject.put(TYBrtWebMapFields.KEY_WEB_MAPINFO_MAPID, mapInfo.getMapID());
		mapInfoObject.put(TYBrtWebMapFields.KEY_WEB_MAPINFO_FLOOR, mapInfo.getFloorName());
		mapInfoObject.put(TYBrtWebMapFields.KEY_WEB_MAPINFO_FLOOR_INDEX, mapInfo.getFloorNumber());
		mapInfoObject.put(TYBrtWebMapFields.KEY_WEB_MAPINFO_SIZEX, mapInfo.getMapSize().x);
		mapInfoObject.put(TYBrtWebMapFields.KEY_WEB_MAPINFO_SIZEY, mapInfo.getMapSize().y);
		mapInfoObject.put(TYBrtWebMapFields.KEY_WEB_MAPINFO_XMIN, mapInfo.getMapExtent().getXmin());
		mapInfoObject.put(TYBrtWebMapFields.KEY_WEB_MAPINFO_XMAX, mapInfo.getMapExtent().getXmax());
		mapInfoObject.put(TYBrtWebMapFields.KEY_WEB_MAPINFO_YMIN, mapInfo.getMapExtent().getYmin());
		mapInfoObject.put(TYBrtWebMapFields.KEY_WEB_MAPINFO_YMAX, mapInfo.getMapExtent().getYmax());
	...
	public static JSONObject generateSymbolJson(List<TYFillSymbolRecord> fillList, List<TYIconSymbolRecord> iconList)
		...
		JSONObject defaultSymbol = new JSONObject();
		{
			...
			String[] defaultKey = { TYBrtWebMapFields.KEY_WEB_DEFAULT_FILL_SYMBOL,
		...
		symbolObject.put(TYBrtWebMapFields.KEY_WEB_DEFAULT_SYMBOL, defaultSymbol);
	...
	public static JSONObject buildWebFillObject(TYFillSymbolRecord record) throws JSONException {
		...
		fillObject.put(TYBrtWebMapFields.KEY_WEB_OUTLINE_COLOR, record.outlineColor);
