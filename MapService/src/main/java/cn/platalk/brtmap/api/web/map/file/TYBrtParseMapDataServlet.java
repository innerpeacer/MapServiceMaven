...
public class TYBrtParseMapDataServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, final HttpServletResponse response)
		...
		TYBrtShpGeneratingTask task = new TYBrtShpGeneratingTask(TYBrtMapEnvironment.GetShpRootDir(buildingID),
				buildingID);
