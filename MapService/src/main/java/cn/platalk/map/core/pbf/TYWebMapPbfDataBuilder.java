...
public class TYWebMapPbfDataBuilder {
	...
	public static TYIndoorDataPbf generateMapDataObject(String mapID,
		...
		TYRenderingSymbolsPbf symbols = TYWebMapSymbol2PbfUtils
	...
	static TYIndoorFeaturePbf fillFeatureToPbf(TYMapDataFeatureRecord record,
		...
		featureBuilder.setGeometry(TYWebMapGeom2PbfUtils
				.geometryToPbf(geometry));
		featureBuilder.setProperties(TYWebMapProperities2PbfUtils
