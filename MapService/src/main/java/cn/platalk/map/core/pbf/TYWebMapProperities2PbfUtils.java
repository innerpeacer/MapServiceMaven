...
public class TYWebMapProperities2PbfUtils {

	public static TYPropertyPbf.TYIndoorFeaturePropertisPbf propertiesToPbf(
			TYMapDataFeatureRecord record) {
		TYIndoorFeaturePropertisPbf.Builder builder = TYIndoorFeaturePropertisPbf
				.newBuilder();
	...
	public static TYPropertyPbf.TYIndoorFeaturePropertisPbf fillPropertiesToPbf(
	...
	public static TYPropertyPbf.TYIndoorFeaturePropertisPbf iconPropertiesToPbf(
		...
		if (iconRecord != null) {
			...
			builder.setImageHighlighted(String.format("%s_highlighted",
					iconName));
		}
