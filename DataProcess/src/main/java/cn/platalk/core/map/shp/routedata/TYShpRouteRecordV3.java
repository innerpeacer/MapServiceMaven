...
public class TYShpRouteRecordV3 {
	...
	TYShpBuildingLinkV3 toLink() {
		TYShpBuildingLinkV3 l = new TYShpBuildingLinkV3(linkID);
	...
	TYShpBuildingNodeV3 toNode() {
		TYShpBuildingNodeV3 n = new TYShpBuildingNodeV3(nodeID);
