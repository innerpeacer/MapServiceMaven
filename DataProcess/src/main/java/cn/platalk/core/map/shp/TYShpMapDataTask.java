...
public class TYShpMapDataTask implements TYBrtMapShpParserListener {
	...
	private final List<TYBrtMapShpTaskListener> listeners = new ArrayList<>();

	public void addTaskListener(TYBrtMapShpTaskListener listener) {
