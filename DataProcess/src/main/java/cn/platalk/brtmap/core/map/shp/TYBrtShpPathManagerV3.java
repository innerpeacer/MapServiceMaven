...
public class TYBrtShpPathManagerV3 implements TYIBrtShpDataManager {
	...
	private static final String ROUTE_SHP_PATH = "%s_%s.shp";
	...
	public TYBrtShpPathManagerV3(String root, String buildingID) {
		this.root = root;
	...
	public String getRouteShpPathV3(String layer, String floor) {
		String floorDir = getFloorDir(floor);
		return new File(floorDir, String.format(ROUTE_SHP_PATH, floor, layer)).toString();
	}
